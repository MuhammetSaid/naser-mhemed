                        ...
                        <div className="section8-content" style={{}}> 
                            ...
                            <h1 style={{margin: "10px", fontFamily: "cairo", direction: "rtl", textAlign: "center"}}>سيرة مختصرة ورؤية لإعادة إعمار حمص</h1>
                                ...
                                <div className="line8" style={{width: "30%", height: "4px", background: "#002724", margin: "20px"}}></div>
                                    ...
                                    <br />
                                    <p>كان سلاحي يومها البارود، حتى كتبنا بالدم صفحة الحرية، أمّا اليوم فسلاحي هو القلم والبناء، لأكتب بالعمل لا بالكلمات وحدها.
                                    </p>
                                    <br />
                                    <p>مرجعيتي هي القانون الذي ناضلنا من أجله أربعة عشر عامًا، فصار بوصلةً ترشد خطاي، لا ميل فيها ولا انحراف.
                                    </p>
                                    <br />
                                    <p>أولوياتي لا تحتمل اللبس: أن نرعى الجرحى الأكثر حاجة، وأن نكون سنداً لأسر الشهداء المحتاجين، وأن نعيد للمنازل دفء الحياة بترميمها، وأن نفتح للطلاب أبواب مدارس أوسع وأجمل، ونمنح معلميهم الدعم ليستمروا في رسالتهم. أن نطوّر البنية التحتية للمياه والطرق، ونشق طرقاً جديدة رحبة تليق بمدينة الحرية، وأن نرفع من شأن المشافي، وأن نقف إلى جانب المزارعين في مواجهة قلة المطر.
                                    </p>
                                    <br />
                                    <p>كما أؤمن بأن العلم والتقنية هما مفتاح المستقبل، وخصوصاً العلوم التطبيقية التي تحول المعرفة إلى إنتاج وحلول حقيقية. لذلك سأدعم تطوير المختبرات والورش العلمية، وأحفّز الشباب على الابتكار والتطبيق العملي، لنجعل من حمص مركزاً للإبداع والمهارات التي تخدم المجتمع وتفتح آفاقاً جديدة لاقتصادنا وبنائنا المدني.
                                    </p>
                                    <br />
                                    <p>لست في مجلس الشعب لأبيع الناس أحلاما معلّقة، بل لأحوّلها إلى واقع ببرنامج زمني واضح ودقيق.
                                    </p>
                                    <br />
                                    <p>لقد طوينا صفحة الحرب في ميادين التحرير، واليوم تبدأ ملحمة البناء؛ معركتنا أن نعيد لحمص وجهها المشرق، وأن نصوغها كما تستحق أن تكون: عاصمة الثورة السورية.
                                    </p>
                                    <br />
